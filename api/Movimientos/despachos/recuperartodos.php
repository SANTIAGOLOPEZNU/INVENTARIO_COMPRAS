...
try {
    ...
    $stmt = $conn->query("SELECT *, Nombre_Destinatario FROM Cabecera_Despacho INNER JOIN  Destinatario ON Cabecera_Despacho.Id_Destinatario = Destinatario.IdDestinatario");
